...
- Повесьте в доме или на рабочем месте (ориентируясь по сторонам света — север вверху)
- Украсьте сектора соответствующими цветами, символами, лампами, благовониями или мантрами.
""")
